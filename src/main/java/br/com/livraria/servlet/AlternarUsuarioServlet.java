...
@WebServlet("/AlternaUsuario")
public class AlternarUsuarioServlet extends HttpServlet{
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Usuario user = new Usuario(nome, cpf, email, senha, grupo);

        UserDAO userDAO = new UserDAO();
        userDAO.alternarUsuario(user, confirmacaoSenha);

        resp.sendRedirect(req.getContextPath() + "/ListarUsuariosServlet");
    }
}
